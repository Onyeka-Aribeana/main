...
class AnchorLayoutExample(AnchorLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.name_field = TextInput(multiline=False, size_hint=(1, 0.3))
        self.password_label = Label(text="Password:", color=(0.6, 0, 0.6, 1), font_size=18, size_hint=(0.3, 0.3))
        self.password_field = TextInput(multiline=False, size_hint=(1, 0.3))
    ...
    def on_submit(self, instance):
        if self.name_field.text == "Onyeka" and self.password_field.text == "chicken":
            ...
            popupLabel = Label(text=f"Username and Password correct\nWelcome {self.name_field.text.title()}")
            closeButton = Button(text="OK", bold=True)
